...
class TestContribute(TestCase):
    ...
    def test_contribute_en_template(self, render_mock):
        ...
        render_mock.assert_called_once_with(req, 'mozorg/contribute/contribute-2020.html', ANY)
    ...
    def test_contribute_locale_template(self, render_mock):
        ...
        req.locale = 'es-ES'
        views.contribute(req)
        render_mock.assert_called_once_with(req, 'mozorg/contribute/index.html', ANY)
